...
public class Hunter extends Enemy {
    ...
    public Hunter(EternalSemester game, World world, Player player) {
    ...
    public void draw(float delta) {
        game.batch.draw(getFrame(delta), getPosition().x - 3*WIDTH/2 + (isFacingRight ? 9 : -9), getPosition().y - 3*HEIGHT/2 + 9, 3*WIDTH, 3*HEIGHT);

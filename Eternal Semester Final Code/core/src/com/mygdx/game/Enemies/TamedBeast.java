...
public class TamedBeast extends Enemy {
    ...
    public static int speed = 40 / ((int)Constants.PPM / 3);
    public static int damage = 120;
    public static int xp = 60;
    ...
    public TamedBeast(EternalSemester game, World world, Player player, Levels level) {
    ...
    public void createBody() {
        ...
        shape.setRadius((3 * 30/2) / Constants.PPM);
    ...
    public void draw(float delta) {
        game.batch.draw(getFrame(delta), getPosition().x - (3*WIDTH/2)/ Constants.PPM, getPosition().y -( 3*HEIGHT/2 - 9)/ Constants.PPM, 3*WIDTH / Constants.PPM, 3*HEIGHT / Constants.PPM);
